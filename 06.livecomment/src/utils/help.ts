...
export const getName = () =>  nameList[Math.floor(Math.random() * nameList.length)];
...
export function generateRandomComment() {
    const commentTemplates = [
      ...
      "Looking clean and well-structured.",
      "Can you explain this part more?",
      "Awesome! Learned something new.",
      "Solid effort, keep it going!",
      "Nice layout, very readable code.",
      "Interesting approach to the task.",
      "Could use more comments inside.",
      "Code is neat and efficient too.",
      "You’re improving very quickly!",
      "Impressive! Well thought out.",
      "UI looks clean and responsive.",
      "Love how modular this feels!",
      "Nice use of components here.",
      "Try to simplify this logic.",
      "Very clean and consistent work.",
      "Try avoiding repetition here.",
      "Functional and user-friendly UI.",
      "Logic seems easy to follow."
    ];
